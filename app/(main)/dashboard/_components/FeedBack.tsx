...
const GetAbstractImages = (option:any) => {
  ...
  return (
    <div>
        ...
        {discussionRoomList?.length ==0 &&  <h2 className='text-gray-400'>You do not have any previous interview feedback</h2>}
      
        <div className='mt-5'>
  {discussionRoomList?.map((item, index) => 
    (item.coachingOptions === 'Ques Ans Prep' || item.coachingOptions === 'Mock Interview') && (
